...
public class C02_OOP {
	public static void main(String[] args) {
		...
		// -> 먹는다(크기, 칼로리 변화)
		// -> 갈변 (색깔, 당도 변화)
		// -> 던진다 (보유한 데미지에 따라 아픈 정도가 달라진다)

		// ex : 학생
		// - 학생의 변수 : 성적, 성별, 키, 학년, 나이, 교복...
		// - 학생의 메서드
		// -> 시험을 친다(최신 성적으로 업데이트)
		// -> 1년이 지난다(학년이 올라감)
		// -> 유급한다(나이만 먹고 학년은 그대로)
...
//			apple03.eat();	
		...
		// 1. myobj.fruit 패키지에 클래스를 하나 정의하고 인스턴스를 생성해보시오.
		...
		grape01.eat(1);
		System.out.println();
		// 2. myobj.vehicle 패키지에 클래스를 하나 정의하고 인스턴스를 생성해보시오.
...
} // 중괄호만 보고도 클래스 바깥인것을 짐작할 수 있어야 한다.
