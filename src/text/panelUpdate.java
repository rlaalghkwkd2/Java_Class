...
import text.Action.Update_SearchAction;
import text.contoller.Update_Contoller;
...
public class panelUpdate extends JPanel implements ItemListener {
	...
	public panelUpdate() {
		...
		textSearch.setBounds(270, 116, 250, 26);
		...
		ponBox.addActionListener(new ComboBoxInput(panelMenu, textPon00, ponlist));
		...
		eMailBox.addActionListener(new ComboBoxInput(panelMenu, textEmail02, maillist));
		...
		btnSearch.setBounds(532, 115, 65, 26);
		panelMenu.add(btnSearch);

		checkMan.setBounds(100, 280, 41, 23);
		panelMenu.add(checkMan);

		checkWomen.setBounds(145, 280, 41, 23);
		panelMenu.add(checkWomen);

		btnSearch.addActionListener(new Update_SearchAction(this, textSearch, textName, textAge, tGender, textPon01,
		...
		lblNewLabel.setFont(new Font("±Ã¼­Ã¼", Font.PLAIN, 15));
		...
		btnUpdate.setBounds(683, 497, 65, 26);
