...
public class Frame01 extends JFrame {
	...
	private Image img_logo = new ImageIcon(Frame01.class.getResource("res/abc.jpg")).getImage().getScaledInstance(249,
			144, Image.SCALE_SMOOTH);
	private panelInput panelInput;
	private panelSearch panelSearch;
	private panelCustomCheck panelCustomCheck;
...
//		setUndecorated(true);
		...
		panelInputs.setBackground(new Color(0, 128, 128));
...
//				new panelSearch();
		...
		panelSearchs.setBackground(new Color(0, 128, 128));
		...
		panelCustomChecks.setBackground(new Color(0, 128, 128));
		...
		panelUpdates.setBackground(new Color(0, 128, 128));
		...
		panelCustomDeletes.setBackground(new Color(0, 128, 128));
		...
		panelBlackIns.setBackground(new Color(0, 128, 128));
		...
		panelBlackDeletes.setBackground(new Color(0, 128, 128));
		...
		panelHomes.addMouseListener(new MouseAdapter() {
			@Override
		...
		panelHomes.setBackground(new Color(0, 128, 128));
		...
		panelInput = new panelInput();
		panelInput.setBounds(0, 0, 806, 533);
