...
public class C12_tryCatchFinally {
	...
	public static void main(String[] args) {
		...
		try {
			...
			// Integer.parseInt(str) : 문자열을 int타입의 값으로 변환하는 메서
			System.out.println(Integer.parseInt("12")); // 예외 발생 코드 2
			
			System.out.printf("%d", "abc");				// 예외 발생 코드 3
...
//			// e.printStackTrace(); // 예외 발생 시 기본동작이었던 것.
//			// System.exit(0);
//		}
